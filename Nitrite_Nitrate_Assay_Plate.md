...
2. Subtract the average absorbance of the nanopure water tubes (i.e., 0 µM NOx) mixed with diluting solution/medium instead of the SULF/NEDD mixture (standard blanks) from the absorbances of all the standards.
